...
% -----------------------------------------------------------
% Modeling: check_error_SEIRD.m
%
% This is a main file for check the rhs_SEIRD.m 
...
disp(' ')
disp(' -----------------------------------------------')
disp(' ++++++++++++++ rhs_SEIRD checking +++++++++++++')
% -----------------------------------------------------------

% Case 1: length(param) < 5 
% -----------------------------------------------------------  
t = 1;                      % time
y = [999 0 1 0 0 1];        % state vector
param = [1000 0.5 0.5 0.1]; % parameters vector

try  
    rhs_SEIRD(t,y,param)
catch ME
    disp(' ')
    disp('Case 1: length(param) < 5')
    disp(['t: ',num2str(t)])
    disp(['y: ',num2str(y)])
...
% Case 2: length(param) > 5
% -----------------------------------------------------------  
param = [1000 0.5 0.5 0.5 0.5 0.1]; % parameters vector

try  
    rhs_SEIRD(t,y,param)
catch ME
    disp(' ')
    disp('Case 2: length(param) > 5')
    disp(['t: ',num2str(t)])
    disp(['y: ',num2str(y)])
    disp(['param: ',num2str(param)])
    disp(' ')
...
% -----------------------------------------------------------  
param = [1000.25 0.5 0.5 0.5 0.1]; % parameters vector
...
% Case 4: param(1) < 0
% -----------------------------------------------------------  
param = [-1000 0.5 0.5 0.5 0.1]; % parameters vector
...
dy = rhs_SEIRD(t,y,param);

disp(' ')
disp('Case 9: valid input')
disp(['t :',num2str(t)])
disp(['y: ',num2str(y)])
disp(['param: ',num2str(param)])
disp(' ')
