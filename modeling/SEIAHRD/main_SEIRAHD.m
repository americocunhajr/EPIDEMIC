...
%
% This is the main file for the SEIRAHD epidemic model, which
...
% plot all compartments of SEIRAHD model
figure(1)
hold on
fig1(1) = plot(time,S);
fig1(2) = plot(time,E);
...
hold off
    ...
    saveas(figure(1),'fig_modeling_SEIRAHD_example1_compart.png')
...
fig2 = scatter([1:length(NewCases)]+1,NewCases);
    ...
    saveas(figure(2),'fig_modeling_SEIRAHD_example1_newcases.png')
% -----------------------------------------------------------
