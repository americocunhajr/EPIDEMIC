...
% Case 1: length(param) < 9 
% -----------------------------------------------------------  
t = 1;                                      % time
y = [999 0 1 0 0 0 0 1];                    % state vector
param = [1000 0.5 0.5 0.1 0.1 0.5 0.2 0.3]; % param. vector

try  
    rhs_SEIAHRD(t,y,param)
catch ME
    disp(' ')
    disp('Case 1: length(param) < 9')
    disp(['t: ',num2str(t)])
    disp(['y: ',num2str(y)])
...
% Case 2: length(param) > 9
% -----------------------------------------------------------  
param = [1000 0.5 0.5 0.1 0.1 0.5 0.2 0.3 0.2 0.2]; % parameters vector

try  
    rhs_SEIAHRD(t,y,param)
catch ME
    disp(' ')
    disp('Case 2: length(param) > 9')
    disp(['t: ',num2str(t)])
    disp(['y: ',num2str(y)])
    disp(['param: ',num2str(param)])
    disp(' ')
...
% -----------------------------------------------------------  
param = [1000.25 0.5 0.5 0.5 0.1 0.3 0.2 0.2 0.2]; % parameters vector
...
% Case 4: param(1) < 0
% -----------------------------------------------------------  
param = [-1000 0.5 0.5 0.5 0.1 0.3 0.2 0.2 0.2]; % parameters vector
...
% Case 13: param(3) > 1
% -----------------------------------------------------------  
param = [1000 0.5 1.1 0.5 0.1 0.3 0.2 0.2 0.2]; % parameters vector

try  
    rhs_SEIAHRD(t,y,param)
catch ME
    disp(' ')
    disp('Case 13: param(3) > 1')
    disp(['t: ',num2str(t)])
    disp(['y: ',num2str(y)])
    disp(['param: ',num2str(param)])
    disp(' ')
...
% Case 14: param(5) > 1
% -----------------------------------------------------------  
param = [1000 0.5 0.5 0.5 1.1 0.3 0.2 0.2 0.1]; % parameters vector

try  
    rhs_SEIAHRD(t,y,param)
catch ME
    disp(' ')
    disp('Case 14: param(5) > 1')
    disp(['t: ',num2str(t)])
    disp(['y: ',num2str(y)])
    disp(['param: ',num2str(param)])
    disp(' ')
...
% Case 15: param(9) > 1
% -----------------------------------------------------------  
param = [1000 0.5 0.5 0.5 0.5 0.3 0.2 0.2 1.1]; % parameters vector

try  
    rhs_SEIAHRD(t,y,param)
catch ME
    disp(' ')
    disp('Case 15: param(9) > 1')
    disp(['t: ',num2str(t)])
    disp(['y: ',num2str(y)])
    disp(['param: ',num2str(param)])
    disp(' ')
