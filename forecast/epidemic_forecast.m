...
lgd=legend([c b aaa bbb ccc pp],'Notifications','Forecasts: ',[d1,': between ',num2str(round(10.^(lowerCI_cases5f(1,1)))),' and ', num2str(round(10.^(upperCI_cases5f(1,1)))),' ','cases'],...
...
% Legend configuration
lgd=legend([c b aaa bbb ccc pp],'Notifications','Forecasts: ',[d1,': between ',num2str(round(10.^(lowerCI_deaths5f(1,1)))),' and ', num2str(round(10.^(upperCI_deaths5f(1,1)))),' ','deaths'],...
