...
[^1]: [www.EpidemicCode.org]
  ...
  [2]: #figtimeseries {reference-type="ref" reference="figtimeseries"}
   ...
   [Trend graph of total number of deaths per 1M inhabitants in several countries generated in EPIDEMIC.]:mortality-pm_2020-05-16.png {#mortality-pm_2020-05-16 width="85%"}
